  ...
  return (
    <div className="">
      ...
      <div className="grid place-items-center py-5">
        <h1 className="text-5xl font-bold text-white">Exchange Student Items</h1>
          ...
          <div className="relative z-10 flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl">
            ...
            <form className="relative w-full mt-6 space-y-8">
              ...
              <div className="relative">
                ...
                <input type="text" className="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="For eg: A matress" />
              </div>
              <div className="relative">
